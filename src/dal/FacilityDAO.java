...
//
// // set Group
// String st1 = "INSERT INTO BuildingGroup (Group_ID, GroupName, GroupOwner)
// VALUES"
// + " (?, ?, ?)";
...
// String st2 = "INSERT INTO Building (Building_ID, BuildingName,
// BuildingOwner,"
...
// String st3 = "INSERT INTO Room (Room_ID, RoomName, RoomOwner, UsageType,
// Building_ID)"
// + " VALUES (?, ?, ?, ?, ?)";
...
//
// //set Manager
// String st5 = "INSERT INTO Manager (Manager_ID, FName, LName, Phone,
// CompanyName,"
// + " Room_ID) VALUES (?, ?, ?, ?, ?, ?)";
...
//
// // get Group
// String st1 = "SELECT Group_ID, GroupName, GroupOwner FROM BuildingGroup WHERE
// Group_ID"
// + " = " + groupID;
// Group g = new Group();
...
// String st2 = "SELECT Building_ID, BuildingName, BuildingOwner,
// ConstructionDate FROM "
...
// b.setConstructionDate(new
// java.util.Date(bRS.getDate("ConstructionDate").getTime()));
// }
// g.addNewFacility(b);
// bRS.close();
//
