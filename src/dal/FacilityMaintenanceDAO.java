...
//
// //set Request
// String st1 = "INSERT INTO Request (Request_ID, DateRequested,
// TextDescription) VALUES"
// + " (?, ?, ?)";
...
//
// //set Maintenance
// String st2 = "INSERT INTO Maintenance (Maintenance_ID, Status, Priority,
// MaintenanceType,"
...
//
// // set Schedule
// String st3 = "INSERT INTO Schedule (Schedule_ID, DateScheduled,
// Maintenance_ID) "
// + "VALUES (?, ?, ?)";
...
//
// // set Service
// String st4 = "INSERT INTO Service (Service_ID, ServiceTime, Schedule_ID)
// VALUES (?,"
// + " ?, ?)";
...
//
// // set Cost
// String st5 = "INSERT INTO Cost (Cost_ID, LaborCost, MaterialCost, Extra,
// Service_ID) "
// + "VALUES (?, ?, ?, ?, ?)";
...
//
// // get Request
// String st1 = "SELECT Request_ID, DateRequested, TextDescription FROM
// FacilityUsage "
...
//
// // get Maintenance
// String st2 = "SELECT Maintenance_ID, Status, Priority, MaintenanceType,
// IssueDescription"
...
//
// // get Schedule
// String st3 = "SELECT Schedule_ID, DateScheduled FROM Schedule WHERE
// Maintenance_ID = "
// + m.getMaintenanceID();
// ResultSet schRS = st.executeQuery(st3);
// Schedule sch = new Schedule(new
// java.util.Date(schRS.getDate("DateScheduled").getTime()));
// while (schRS.next()) {
...
//
// // get Cost
// String st5 = "SELECT Cost_ID, LaborCost, MaterialCost, Extra FROM Cost WHERE
// Service_ID"
// + " = " + s.getServiceID();
