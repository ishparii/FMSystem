...
//
// //set Usage
// String st1 = "INSERT INTO FacilityUsage (Usage_ID, UsageType, StartDate,
// EndDate) "
// + "VALUES (?, ?, ?, ?)";
...
//
// //set User
// String st2 = "INSERT INTO FacilityUser (User_ID, FName, LName, Gender,
// Usage_ID) VALUES"
// + " (?, ?, ?, ?, ?)";
...
//
// // get Usage
// String st1 = "SELECT Usage_ID, UsageType, StartDate, EndDate FROM
// FacilityUsage "
// + "WHERE Usage_ID = " + uID;
...
//
// // get User
// String st2 = "SELECT User_ID, FName, LName, Gender FROM User WHERE User_ID =
// " + uID;
